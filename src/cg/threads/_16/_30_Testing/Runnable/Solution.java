package cg.threads._16._30_Testing.Runnable;
...
public class Solution {
    ...
    public static class ReadFileThread implements Runnable, ReadFileInterface {
        ...
        public void run() {
            try{
            BufferedReader reader = new BufferedReader(new FileReader("src/cg/threads/_16/_30_Testing/Runnable/"+ Thread.currentThread().getName()));
