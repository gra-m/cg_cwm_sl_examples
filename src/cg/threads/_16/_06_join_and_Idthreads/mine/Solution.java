package cg.threads._16._06_join_and_Idthreads.mine;
...
public class Solution {
    public static void main(String[] args) throws InterruptedException {
        ...
        firstThread.join(); // main thread paused while ft does its thing
    ...
    public static void printList(List<String> list, String threadName) {
        here: for (int i = 0; i < list.size(); i++) {
            ...
            }else if (threadName.equals("secondThread")){
                if(i > 0 && i < 19)
                    continue;
                if(i == 19)
                    System.out.println("...");
    ...
    public static class PrintListThread extends Thread {
        public PrintListThread(String name) {
            super(name);
        } // This ensures can id Thread by name
