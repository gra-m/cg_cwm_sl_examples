...
public class CompositePatternExample {
    public static void main(String[] args) {
        ...
        SimpleEmployee mTeach2 = new SimpleEmployee("M-Teach-2", "Maths",  4);

        SimpleEmployee cTeach1 = new SimpleEmployee("C-Teach-1", "C-Science", 4);
        SimpleEmployee cTeach2 = new SimpleEmployee("C-Teach-2", "C-Science",  4);
        SimpleEmployee cTeach3 = new SimpleEmployee("C-Teach-3", "C-Science", 4);

        // DeptHeads
        CompositeEmployee hOD_Maths = new CompositeEmployee("Mrs. S. Das (HOD-Maths)", "Maths", 4);
        CompositeEmployee hOD_C_Science = new CompositeEmployee("Mr. V. Sarcar (HOD-C-Science)", "C-Science", 4);
